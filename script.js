...
let fightAudio = new Audio("fight.mp3");
...
function goTown() {
  ...
  startAudio.play();
  update(locations[0]);
  body.style.backgroundImage = "url(outsideStore.jpg)"
}

function goStore() {
  update(locations[1]);
  body.style.backgroundImage = "url(store.jpg)"
}
...
function sellWeapon() {
  if (inventory.length > 1) {
    ...
    text.inner += " In your inventory you have: " + inventory;
  } else {
...
function fightSlime() {
  fighting = 0;
  body.style.backgroundImage = "url(slime.jpg)"
  goFight();
}

function fightBeast() {
  fighting = 1;
  body.style.backgroundImage = "url(beast.jpg)"
  goFight();
}

function fightDragon() {
  fighting = 2;
  body.style.backgroundImage = "url(dragon.jpg)"
  goFight();
}
...
function goFight() {
  ...
  monsterStats.style.justifyContent = "center";
  monsterStats.style.gap = "40px"
